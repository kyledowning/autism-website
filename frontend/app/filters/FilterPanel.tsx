    ...
    <div className="space-y-4">
      ...
      <FilterSection
        ...
        options={[
          ...
          { value: 'locationbelgium', label: 'Belgium'},
          { value: 'locationbrazil', label: 'Brazil'},
          { value: 'locationcanada', label: 'Canada'},
          { value: 'locationchina', label: 'China'},
          { value: 'locationdenmark', label: 'Denmark'},
          { value: 'locationecuador', label: 'Ecuador'},
          { value: 'locationfrance', label: 'France'},
          { value: 'locationgermany', label: 'Germany'},
          { value: 'locationindia', label: 'India'},
          { value: 'locationindonesia', label: 'Indonesia'},
          { value: 'locationiran', label: 'Iran'},
          { value: 'locationitaly', label: 'Italy'},
          { value: 'locationjapan', label: 'Japan'},
          { value: 'locationmalaysia', label: 'Malaysia'},
          { value: 'locationnetherlands', label: 'Netherlands'},
          { value: 'locationpakistan', label: 'Pakistan'},
          { value: 'locationpoland', label: 'Poland'},
          { value: 'locationromania', label: 'Romania'},
          { value: 'locationrwanda', label: 'Rwanda'},
          { value: 'locationsaudiarabia', label: 'Saudi Arabia'},
          { value: 'locationsouthafrica', label: 'South Africa'},
          { value: 'locationsouthkorea', label: 'South Korea'},
          { value: 'locationspain', label: 'Spain'},
          { value: 'locationsweden', label: 'Sweden'},
          { value: 'locationthailand', label: 'Thailand'},
          { value: 'locationuae', label: 'United Arab Emirates'},
          { value: 'locationuk', label: 'United Kingdom'},
      ...
      <FilterSection
        ...
        options={[
          ...
          { value: 'authoraffiliationcanada', label: 'Canada'},
          { value: 'authoraffiliationchina', label: 'China'},
          { value: 'authoraffiliationegypt', label: 'Egypt'},
          { value: 'authoraffiliationfinland', label: 'Finland'},
          { value: 'authoraffiliationfrance', label: 'France'},
          { value: 'authoraffiliationhungary', label: 'Hungary'},
          { value: 'authoraffiliationindia', label: 'India'},
          { value: 'authoraffiliationindonesia', label: 'Indonesia'},
          { value: 'authoraffiliationiraq', label: 'Iraq'},
          { value: 'authoraffiliationisrael', label: 'Israel'},
          { value: 'authoraffiliationitaly', label: 'Italy'},
          { value: 'authoraffiliationjapan', label: 'Japan'},
          { value: 'authoraffiliationnetherlands', label: 'Netherlands'},
          { value: 'authoraffiliationnorway', label: 'Norway'},
          { value: 'authoraffiliationpakistan', label: 'Pakistan'},
          { value: 'authoraffiliationpoland', label: 'Poland'},
          { value: 'authoraffiliationromania', label: 'Romania'},
          { value: 'authoraffiliationsaudiarabia', label: 'Saudi Arabia'},
          { value: 'authoraffiliationslovakia', label: 'Slovakia'},
          { value: 'authoraffiliationsouthkorea', label: 'South Korea'},
          { value: 'authoraffiliationspain', label: 'Spain'},
          { value: 'authoraffiliationsrilanka', label: 'Sri Lanka'},
          { value: 'authoraffiliationthailand', label: 'Thailand'},
          { value: 'authoraffiliationuae', label: 'United Arab Emirates'},
          { value: 'authoraffiliationuk', label: 'United Kingdom'},
          { value: 'authoraffiliationukraine', label: 'Ukraine'},
          { value: 'authoraffiliationusa', label: 'United States'},
          { value: 'authoraffiliationvietnam', label: 'Vietnam'},
        ]}
      />
